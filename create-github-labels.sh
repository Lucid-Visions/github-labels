...
LABELS=(
  "Needs QA"            "7057ff"  "Pull request need a QA Engineer to test it"
  "Needs Review"        "7057ff"  "Pull request needs a peer review"
  "WIP"       		"fbca04"  "Pull request is a work in progress"
  "Passed QA"           "0e8a16"  "Pull request has QA Engineer testing"
  "Passed Review"       "0e8a16"  "Pull request has passed all peer reviews"
  "Failed QA"		"d73a4a"  "Pull request has failed QA Engineer testing"
  "Needs Rebase"	"9F5195"  "Pull request needs rebased or has conflicts"
  "On Hold"       "B60205"  "Pull request is on hold or awaiting clarification"
